...
// The current wifi SSID can be fetched via two different macOS commands.
// The user can pick which one the network widget uses.
const ssidSources = [
  { code: "system_profiler", name: "system_profiler (default)" },
  { code: "networksetup", name: "networksetup" },
];
...
export const data = {
  ...
  networkWidgetOptions: {
    ...
    infos: [
      ...
      "The SSID command source lets you switch between system_profiler and networksetup for reading the current network name.",
    ],
  },
